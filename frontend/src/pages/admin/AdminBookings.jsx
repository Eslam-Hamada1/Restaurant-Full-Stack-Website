                                        ...
                                        <td className="p-3 text-center">
                                            {b.status === "pending" && (
                                                <div className="flex justify-center gap-2">
                                                    <button onClick={() => handleAction(b.id, "accept")} className="bg-green-500 text-white px-3 py-1 rounded-lg hover:bg-green-600">Accept</button>
                                                    <button onClick={() => handleAction(b.id, "reject")} className="bg-red-500 text-white px-3 py-1 rounded-lg hover:bg-red-600">Reject</button>
                                                </div>
                                            )}
                                        </td>
                                    </tr>
