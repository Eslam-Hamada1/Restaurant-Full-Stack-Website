...
export default function AdminMenu() {
    ...
    return (
        ...
        <main className="flex-grow container mx-auto px-6 py-12">
            ...
            <button type="submit" className="bg-yellow-500 text-white px-6 py-2 rounded-lg hover:bg-yellow-600">
            ...
            <tbody>
                ...
                <tr key={item.id} className="border-b hover:bg-gray-50">
                    ...
                    <button onClick={() => startEdit(item)} className="bg-blue-500 text-white px-3 py-1 rounded-lg hover:bg-blue-600 mr-2">
                        Edit
                    </button>
                    <button onClick={() => handleDelete(item.id)} className="bg-red-500 text-white px-3 py-1 rounded-lg hover:bg-red-600">
                        Delete
                    </button>
                    </td>
                </tr>
