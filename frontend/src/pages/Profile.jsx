...
export default function Profile() {
    ...
    return (
        ...
        style={{
            backgroundImage:
            "url('https://wallpapers.com/images/hd/food-4k-1pf6px6ryqfjtnyr.jpg')",
        }}
        >
        <Navbar />
    ...
    return (
        ...
        {editingField === "password" ? (
            ...
            <button
                ...
                className="bg-yellow-500 text-white py-1 rounded-lg hover:bg-yellow-600"
            >
                Save
            </button>
            </div>
