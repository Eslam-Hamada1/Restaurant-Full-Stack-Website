    ...
    return (
        ...
        <section className="flex flex-col md:flex-row items-center justify-between px-8 md:px-20 py-16 space-y-8 md:space-y-0 md:space-x-12">
            ...
            <div className="md:w-1/2 space-y-4">
                ...
                <p className="text-gray-600 leading-relaxed">
                    Welcome to <span className="font-semibold text-yellow-600">Foodie</span> — where passion for food meets creativity.
                ...
                <p className="text-gray-600 leading-relaxed">From cozy family dinners to vibrant celebrations, we create moments of joy through delicious flavors. Every plate tells a story, and we're thrilled to share ours with you.</p>
            </div>
        </section>
        ...
        <section className="bg-yellow-50 py-16 px-8 md:px-20">
            <div className="text-center mb-10">
                ...
                <p className="text-gray-600 mt-2">Great food, great people, great experiences — that’s what we believe in.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="bg-white rounded-xl shadow p-6 hover:shadow-lg transition">
                    <h3 className="text-xl font-semibold text-yellow-600 mb-2">Fresh Ingredients</h3>
                    <p className="text-gray-600 text-sm">We source only the freshest ingredients from local farms to bring you authentic, flavorful meals.</p>
                </div>
                
                <div className="bg-white rounded-xl shadow p-6 hover:shadow-lg transition">
                    <h3 className="text-xl font-semibold text-yellow-600 mb-2">Exceptional Quality</h3>
                    <p className="text-gray-600 text-sm">Every dish is prepared with care and creativity to deliver the perfect balance of taste and presentation.</p>
                </div>
                
                <div className="bg-white rounded-xl shadow p-6 hover:shadow-lg transition">
                    <h3 className="text-xl font-semibold text-yellow-600 mb-2">Warm Hospitality</h3>
                    <p className="text-gray-600 text-sm">We strive to make every visit a memorable one with our friendly staff and cozy atmosphere.</p>
                </div>
            </div>
        </section>
        ...
        <section className="py-16 px-8 md:px-20 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                {[
                    { name: "Antonio De Mahmoud", role: "Head Chef", img: "https://randomuser.me/api/portraits/men/32.jpg" },
                    { name: "Maria Hamada", role: "Pastry Specialist", img: "https://randomuser.me/api/portraits/women/44.jpg" },
                    { name: "Eslam Smith", role: "Restaurant Manager", img: "https://randomuser.me/api/portraits/men/45.jpg" },
                ].map((member, index) => (
